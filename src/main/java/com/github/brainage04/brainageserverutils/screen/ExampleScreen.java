package com.github.brainage04.brainageserverutils.screen;
...
public class ExampleScreen extends Screen {
    ...
    @Override
    protected void init() {
        button = ButtonWidget.builder(Text.literal("Button"), button -> BrainageServerUtils.LOGGER.info("You clicked a button!"))
